...
class SimpsonApp(tk.Tk):
    def __init__(self):
        tk.Tk.__init__(self)
        self.title("Método de Simpson 1/3")
        ...
        self.label = tk.Label(self, text="Resultado del método de Simpson 1/3: {:.2f}".format(self.simpson))
    ...
    def mostrar_resultados(self):
        ...
        resultado = "Resultado del método de Simpson 1/3: {:.2f}".format(self.simpson)
        messagebox.showinfo("Resultado", resultado)

        self.label.configure(text="Resultado del método de Simpson 1/3: {:.2f}".format(self.simpson))
